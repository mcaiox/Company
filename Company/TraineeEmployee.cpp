...
TraineeEmployee::TraineeEmployee(const string &first, const string &last, const string &id, double salary) : EmployeeBase(first, last, id)
{
...
double TraineeEmployee::getMonthlySalary() const
{
    return monthlySalary;
    
}

double TraineeEmployee::earnings() const
{
